...
const CardProductItem = ({ product }) => {
  ...
  const { product_id, product_name, priceUpdateDetails, image, category, status } = product;
  const formattedPrice = priceUpdateDetails.length > 0 ? (priceUpdateDetails[0].price_new).toLocaleString('en') : '';
